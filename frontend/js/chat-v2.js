...
(function() {
    ...
    window.ChatV2Component = defineComponent({
        name: 'ChatV2Component',
        props: {
            tabId: {
                type: String,
                required: true
        ...
        const renderMarkdown = (content) => {
            ...
            try {
                ...
                if (typeof marked === 'undefined' || typeof DOMPurify === 'undefined') {
                    console.warn('Markdown 库未加载，使用纯文本显示');
                    return content;
                }
                // 解析 Markdown
        ...
        return {
            ...
            resetSession,
            handleKeyDown,
            renderMarkdown, // 新增：Markdown 渲染函数
            // 新增字段
            traceId,
            autoTraceId,
            recordDateTime,
            ...
            >
                ...
                >
                    ...
                    <div style="flex: 1; max-width: 70%;">
                        <div 
                            :class="['message-content', msg.role, msg.role === 'assistant' ? 'markdown-content' : '']"
